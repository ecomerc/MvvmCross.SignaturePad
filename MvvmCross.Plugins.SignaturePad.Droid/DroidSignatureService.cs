...
using EcoMerc.MvvmCross.Plugins.SignaturePad.Droid.Extensions;


namespace EcoMerc.MvvmCross.Plugins.SignaturePad.Droid {
	...
	public class DroidSignatureService : ISignatureService {
		...
		public virtual Task<SignatureResult> Request(SignaturePadConfiguration config, CancellationToken cancelToken) {
            ...
            var recieverIntent = new Android.Content.IntentFilter("EcoMerc.MvvmCross.plugins.signaturepad.droid.SIGNATURE");
